...
pip install git+ssh://git@github.com/tzafon/lightcone.git
```
...
```sh
# install from the production repo
pip install 'tzafon[aiohttp] @ git+ssh://git@github.com/tzafon/lightcone.git'
```
...
These methods return an [`APIResponse`](https://github.com/tzafon/lightcone/tree/main/src/tzafon/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/tzafon/lightcone/tree/main/src/tzafon/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/tzafon/lightcone/issues) with questions, bugs, or suggestions.
