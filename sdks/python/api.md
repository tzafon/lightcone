...
- <code title="post /v1/responses">client.responses.<a href="./src/tzafon/resources/responses.py">create</a>(\*\*<a href="src/tzafon/types/response_create_params.py">params</a>) -> <a href="./src/tzafon/types/responses_response.py">ResponsesResponse</a></code>
- <code title="get /v1/responses/{id}">client.responses.<a href="./src/tzafon/resources/responses.py">retrieve</a>(id) -> <a href="./src/tzafon/types/responses_response.py">ResponsesResponse</a></code>
- <code title="delete /v1/responses/{id}">client.responses.<a href="./src/tzafon/resources/responses.py">delete</a>(id) -> <a href="./src/tzafon/types/response_delete_response.py">ResponseDeleteResponse</a></code>
- <code title="post /v1/responses/{id}/cancel">client.responses.<a href="./src/tzafon/resources/responses.py">cancel</a>(id) -> <a href="./src/tzafon/types/responses_response.py">ResponsesResponse</a></code>

# Chat

Methods:

- <code title="post /chat/completions">client.chat.<a href="./src/tzafon/resources/chat.py">create_completion</a>(\*\*<a href="src/tzafon/types/chat_create_completion_params.py">params</a>) -> object</code>

# Models

Methods:

- <code title="get /models">client.models.<a href="./src/tzafon/resources/models.py">list</a>() -> object</code>
